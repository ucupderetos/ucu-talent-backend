...
public class LoginRateLimitFilter extends AbstractKeyedRateLimitFilter {
    ...
    public LoginRateLimitFilter(
            ...
            @Value("${security.rate-limit.login.per-ip.lockout-schedule-seconds:60,300,1800}") String ipLockoutScheduleSeconds,
            @Value("${security.rate-limit.login.per-email.lockout-schedule-seconds:30,180,900}") String emailLockoutScheduleSeconds,
