...
// Datos del usuario logueado, resueltos del JWT (sub) + consultados frescos de la base.
...
public record MeResponse(
        ...
        @Schema(description = "Si la empresa esta aprobada por un Admin. Null si el rol no es EMPRESA", example = "true")
        Boolean approved
) {}
